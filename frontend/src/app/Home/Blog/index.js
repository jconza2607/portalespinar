        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <SectionHead
                title="Últimos Comunicados y Noticias Municipales"
                desc="Entérate de lo más reciente: anuncios importantes, campañas, eventos y decisiones de gestión para el desarrollo de Espinar."
              />
            </div>
          </div>
          <div className="row">
